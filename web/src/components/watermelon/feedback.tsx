// Vendored from https://registry.watermelon.sh/r/feedback.json (2026-09-24). Edits: hugeicons/react-icons -> lucide.
import React, { useState } from 'react';
import { motion, AnimatePresence, LayoutGroup } from 'motion/react';
import { X, Sparkle, ThumbsUp, ThumbsDown, Navigation } from 'lucide-react';
const FaThumbsUp = (p: {className?: string}) => <ThumbsUp {...p} fill="currentColor" />;
const FaRegThumbsUp = ThumbsUp;
const FaThumbsDown = (p: {className?: string}) => <ThumbsDown {...p} fill="currentColor" />;
const FaRegThumbsDown = ThumbsDown;
